...
export default function TierRatesVolume() {
  ...
  return scopeData.map(({incentive, minimumVolume, maximumVolume, id}) => (
    <>
      <ExpansionPanel
        key={id}
        square
      ...
      >
        <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
          <Box display="flex" flexDirection="column">
            <Typography variant="subtitle1">Incentive: {incentive}</Typography>
            <Typography color="textSecondary" variant="body2">
              Minimum Volume: {minimumVolume} • Maximum Volume: {maximumVolume}
            </Typography>
          </Box>
